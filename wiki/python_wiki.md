...
## Machine Learning
  ...
  * [Decision Tree](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/decision_tree.py)
	...
	- Output: Map a real number input to a real number output
  * [Gaussian Naive Bayes](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/gaussian_naive_bayes.py)
	- Probabilistic classifiers based on applying Bayes' theorem with strong independence assumptions between the feautures. Naive Bayes is a simple techinique for constructing classifiers: models that assign class labels to problem instances, represented as vectors of feature values, where the class labels are drawn from some finite set. All naive Bayes classifiers assume that the value of a particular feature is independent of the value of any other feature, given the class variable.
	- Using sklearn function and iris dataset
  * [Gradient Descent](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/gradient_descent.py)
	- Implementation of gradient descent algorithm for minimizing cost of a linear hypothesis function. Gradient descent is a first-order iterative optimization algorithm for finding a local minimum of a differentiable function. 
	- Input: param_data_input_tuple
	- Output: value of hypothesis function at that point.
  * [K Means Clust](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/k_means_clust.py)
	- A method of vector quantization. k-means clustering minimizes within-cluster variances. The most common algorithm uses an iterative refinement technique.
	- Input: 2D numpy array of features, number of clusters to create, initial centroid values generated by utility function, maximum number of iterations to process, empty list that will be filled with hetrogeneity values if passed to kmeans function.
  * [K Nearest Neighbours](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/k_nearest_neighbours.py)
	- Non-parametric method used for classification and regression. In KNN classification, the output is a class membership. An object is classified by a plurality vote of its neighbors, with the object being assigned to the class most common among its k nearst neighbors. In KNN regression, the output is the property value for the object. This value is the average of the values of k nearest neighbors. 
	- Here for making data, use numpy array. And fives the euclidean distance between two points. 
  * [Knn Sklearn](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/knn_sklearn.py)
	- Using K Nearest Neighbours Classification to predict iris type.
	- Input: iris data from sklearn.datasets
  * [Linear Discriminant Analysis](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/linear_discriminant_analysis.py)
	- Generalization of Fisher's linear discriminant, a method used in statistics, pattern recognition, and machine learning to find a linear combination of features that characterizes or separates two or more classes of objects or events. LDA is closely related to analysis of variance(ANOVA) and regression analysis, which also attempt to express one dependent variable as a linear combination of other features or measurements. 
	- Data: The input variables have a gaussian distribution and the variance calculated for each input variables by class grouping is the same. 
	- To learn model, LDA model requires the estimation of statistics from the training data. Mean of each input value for each classm Probability of an instance belong to each class and covariance for the input data for each class.
  * [Linear Regression](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/linear_regression.py)
	- Linear regression is a linear approach to modeling the relationship between a scalar response and one or more explanatory variables. We have a dataset and we have features associated with it. Features should be chosen very catiously as they determine how much our model will be able to make future predictions. In here, try to set the weight of these features, over many interations, so that they best fit dataset and use CSGO dataset. 
  * [Logistic Regression](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/logistic_regression.py)
	- Logistic regression is a statistical model that in its basic form uses a logistic function to model a binary dependent variable, although many core complex extensions exist. Mathematically, a binary logistic model has a dependent variable with two possible values, such as pass/fail which is represented by an indicator variable, where the two values are labeled "0" and "1".
  * Lstm
    * [Lstm Prediction](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/lstm/lstm_prediction.py)
	- LSTM(Long Short Term Memory) is a type of Recurrent Neural Network used in the field of deep learning. Unlike standard feedforward neural networks, LSTM has feedback connections. It can not only process single data points, but also entire sequences of data. A common LSTM unit is composed of a cell, an input gate, an output gate and a forget gate. 
  * [Multilayer Perceptron Classifier](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/multilayer_perceptron_classifier.py)
	- Multilayer perceptron is a class of feedforward artificial neural network(ANN). An MLP consists of at least three layers of nodes: an input layer, a hidden layer and an output layer. Except for the input nodes, each node is a neuron that uses a nonlinear activation function. MLP utilizes a supervised learning technique called backpropagation for training. Its multiple layers and non-linear perceptron. It can distinguish data that is not linearly separable.
	- Here use MLPClassfier from sklearn.neural_network 
  ...
  * [Random Forest Classifier](https://github.com/TheAlgorithms/Python/blob/master/machine_learning/random_forest_classifier.py)
	...
	- Using iris dataset for Random Forest Classifier example from sklearn.
